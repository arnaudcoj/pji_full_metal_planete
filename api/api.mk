...
ProjectPath            := "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api"
...
$(OutputFile): $(Objects)
	...
	@$(MakeDirCommand) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/.build-debug"
	@echo rebuilt > "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/.build-debug/api"
...
$(IntermediateDirectory)/game.cpp$(ObjectSuffix): game.cpp $(IntermediateDirectory)/game.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/game.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/game.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/gamestate.cpp$(ObjectSuffix): gamestate.cpp $(IntermediateDirectory)/gamestate.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/gamestate.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/gamestate.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/hexagrid.cpp$(ObjectSuffix): hexagrid.cpp $(IntermediateDirectory)/hexagrid.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/hexagrid.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/hexagrid.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/player.cpp$(ObjectSuffix): player.cpp $(IntermediateDirectory)/player.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/player.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/player.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/cell.cpp$(ObjectSuffix): cell.cpp $(IntermediateDirectory)/cell.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/cell.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/cell.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/mountaincell.cpp$(ObjectSuffix): mountaincell.cpp $(IntermediateDirectory)/mountaincell.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/mountaincell.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/mountaincell.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/plaincell.cpp$(ObjectSuffix): plaincell.cpp $(IntermediateDirectory)/plaincell.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/plaincell.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/plaincell.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/reefcell.cpp$(ObjectSuffix): reefcell.cpp $(IntermediateDirectory)/reefcell.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/reefcell.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/reefcell.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/seacell.cpp$(ObjectSuffix): seacell.cpp $(IntermediateDirectory)/seacell.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/seacell.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/seacell.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/swampcell.cpp$(ObjectSuffix): swampcell.cpp $(IntermediateDirectory)/swampcell.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/swampcell.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/swampcell.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/bigtankpiece.cpp$(ObjectSuffix): bigtankpiece.cpp $(IntermediateDirectory)/bigtankpiece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/bigtankpiece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/bigtankpiece.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/patrolboatpiece.cpp$(ObjectSuffix): patrolboatpiece.cpp $(IntermediateDirectory)/patrolboatpiece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/patrolboatpiece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/patrolboatpiece.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/piece.cpp$(ObjectSuffix): piece.cpp $(IntermediateDirectory)/piece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/piece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/piece.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/pontoonpiece.cpp$(ObjectSuffix): pontoonpiece.cpp $(IntermediateDirectory)/pontoonpiece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/pontoonpiece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/pontoonpiece.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/tankpiece.cpp$(ObjectSuffix): tankpiece.cpp $(IntermediateDirectory)/tankpiece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/tankpiece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/tankpiece.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/weatherlayerpiece.cpp$(ObjectSuffix): weatherlayerpiece.cpp $(IntermediateDirectory)/weatherlayerpiece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/weatherlayerpiece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/weatherlayerpiece.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/crabpiece.cpp$(ObjectSuffix): crabpiece.cpp $(IntermediateDirectory)/crabpiece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/crabpiece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/crabpiece.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/bargepiece.cpp$(ObjectSuffix): bargepiece.cpp $(IntermediateDirectory)/bargepiece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/bargepiece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/bargepiece.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/MineralPiece.cpp$(ObjectSuffix): MineralPiece.cpp $(IntermediateDirectory)/MineralPiece.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/MineralPiece.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/MineralPiece.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/MineralPiece.cpp$(DependSuffix): MineralPiece.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/MineralPiece.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/MineralPiece.cpp$(DependSuffix) -MM "MineralPiece.cpp"

$(IntermediateDirectory)/MineralPiece.cpp$(PreprocessSuffix): MineralPiece.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/MineralPiece.cpp$(PreprocessSuffix) "MineralPiece.cpp"

$(IntermediateDirectory)/piecestock.cpp$(ObjectSuffix): piecestock.cpp $(IntermediateDirectory)/piecestock.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/piecestock.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/piecestock.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/container.cpp$(ObjectSuffix): container.cpp $(IntermediateDirectory)/container.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/container.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/container.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/weapon.cpp$(ObjectSuffix): weapon.cpp $(IntermediateDirectory)/weapon.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/weapon.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/weapon.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/engine.cpp$(ObjectSuffix): engine.cpp $(IntermediateDirectory)/engine.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/api/engine.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/engine.cpp$(ObjectSuffix) $(IncludePath)
