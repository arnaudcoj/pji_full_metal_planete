...
ProjectPath            := "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/interface"
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/.build-debug/interface"
...
$(IntermediateDirectory)/assetmanager.cpp$(ObjectSuffix): assetmanager.cpp $(IntermediateDirectory)/assetmanager.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/interface/assetmanager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/assetmanager.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/grid.cpp$(ObjectSuffix): grid.cpp $(IntermediateDirectory)/grid.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/interface/grid.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/grid.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/hexagon.cpp$(ObjectSuffix): hexagon.cpp $(IntermediateDirectory)/hexagon.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/interface/hexagon.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/hexagon.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/pawn.cpp$(ObjectSuffix): pawn.cpp $(IntermediateDirectory)/pawn.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/interface/pawn.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/pawn.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/animator.cpp$(ObjectSuffix): animator.cpp $(IntermediateDirectory)/animator.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/interface/animator.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/animator.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/pawns.cpp$(ObjectSuffix): pawns.cpp $(IntermediateDirectory)/pawns.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/data/Arnaud/Mes Documents/Cours/Info/Master/M1/S2/pji_full_metal_planete/interface/pawns.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/pawns.cpp$(ObjectSuffix) $(IncludePath)
