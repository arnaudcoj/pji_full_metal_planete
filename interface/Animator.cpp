...
Animator::Animation&
Animator::CreateAnimation(std::string const& name, std::string const& textureName, sf::Time const& duration, bool loop)
{
    ...
    m_Animations.back().AddFrames(sf::Vector2i(0, 0), spriteSize, 2);
